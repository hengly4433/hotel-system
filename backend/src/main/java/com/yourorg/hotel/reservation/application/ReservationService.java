package com.yourorg.hotel.reservation.application;
...
import com.yourorg.hotel.reservation.api.dto.NightlyRateRequest;
import com.yourorg.hotel.reservation.api.dto.ReservationCreateRequest;
import com.yourorg.hotel.reservation.api.dto.ReservationNightResponse;
import com.yourorg.hotel.reservation.api.dto.ReservationResponse;
import com.yourorg.hotel.reservation.api.dto.ReservationRoomRequest;
import com.yourorg.hotel.reservation.api.dto.ReservationRoomResponse;
import com.yourorg.hotel.reservation.api.dto.ReservationUpdateRequest;
...
import com.yourorg.hotel.reservation.domain.ReservationStatus;
import com.yourorg.hotel.reservation.infra.ReservationNightRepository;
import com.yourorg.hotel.reservation.infra.ReservationRepository;
import com.yourorg.hotel.reservation.infra.ReservationRoomRepository;
import com.yourorg.hotel.reservation.infra.ReservationTypeNightRepository;
import com.yourorg.hotel.pricing.domain.RatePlanPriceEntity;
import com.yourorg.hotel.pricing.infra.RatePlanRepository;
import com.yourorg.hotel.pricing.application.RatePlanPriceService;
import com.yourorg.hotel.guest.infra.GuestRepository;
import com.yourorg.hotel.finance.application.FolioService;
import com.yourorg.hotel.finance.domain.FolioEntity;
import com.yourorg.hotel.finance.domain.FolioStatus;
import com.yourorg.hotel.finance.infra.FolioRepository;
...
public class ReservationService {
  ...
  public ReservationResponse create(ReservationCreateRequest request) {
    ...
    reservation.setChannel(request.channel() == null
        ? com.yourorg.hotel.reservation.domain.ChannelType.DIRECT
        : request.channel());
  ...
  private void createReservationTypeNights(ReservationRoomEntity room, List<NightlyCharge> charges) {
    ...
    List<com.yourorg.hotel.reservation.domain.ReservationTypeNightEntity> nights = new ArrayList<>();
    for (NightlyCharge charge : charges) {
      com.yourorg.hotel.reservation.domain.ReservationTypeNightEntity night =
          new com.yourorg.hotel.reservation.domain.ReservationTypeNightEntity();
      night.setReservationRoomId(room.getId());
