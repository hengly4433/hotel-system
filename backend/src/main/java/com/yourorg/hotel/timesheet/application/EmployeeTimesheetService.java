package com.yourorg.hotel.timesheet.application;
...
import com.yourorg.hotel.timesheet.api.dto.EmployeeTimesheetRequest;
import com.yourorg.hotel.timesheet.api.dto.EmployeeTimesheetResponse;
import com.yourorg.hotel.timesheet.domain.EmployeeTimesheetEntity;
import com.yourorg.hotel.timesheet.domain.TimesheetStatus;
import com.yourorg.hotel.timesheet.infra.EmployeeTimesheetRepository;
...
public class EmployeeTimesheetService {
  ...
  public EmployeeTimesheetResponse create(EmployeeTimesheetRequest request) {
    ...
    var shift = request.shift() == null ? com.yourorg.hotel.housekeeping.domain.WorkShift.AM : request.shift();
